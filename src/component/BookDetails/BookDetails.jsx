    ...
    return (
        <div className="lg:flex gap-6 my-10">
            ...
            <div className="flex-1 p-6 bg-gray- rounded-lg space-y-3">
                ...
                <p>{book.category}</p>
                <hr />
                <p><span className="font-bold text-white">Review </span> : {book.review}</p>
                <div className="flex">
                ...
                <div>
                    <table className=" w-96">
                        ...
                        <tr className="">
                        <td>Rating :</td>
                        <td>{book.rating} {book.rating} <FontAwesomeIcon icon={faStar} /></td>
                        </tr>
                    </table>
                    <Link><button onClick={handleRead} className='btn bg-blue-600 border-none mr-4 my-4'>Read</button></Link>
                    <Link><button onClick={handleWish} className='btn bg-blue-600 border-none mr-4 my-4'>Wishlist</button></Link>
                </div>
                <ToastContainer />
            </div>
        </div>
